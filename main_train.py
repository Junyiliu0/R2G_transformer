...
from models.transformer_model import BaseCMNModel
...
def parse_agrs():
    ...
    # Choose the device used for training
    parser.add_argument('--device', type=int, default=0,help='the device used for training')

    # New change
    parser.add_argument('--use_rebuild_data',action='store_true',help='whether to use_the_rebuild the data')
...
def main():
    ...
    print('This code is used for the baseline metrices in transformer')
